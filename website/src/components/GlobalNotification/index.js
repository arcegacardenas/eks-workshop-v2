...
const notificationConfig = {
  ...
  linkText: "Register",
  linkUrl:
    "https://aws-experience.com/emea/smb/events/series/get-hands-on-with-amazon-eks?trk=d42ffbaa-d60a-4513-8a79-0bf36b9f33ce&sc_channel=el",
};
...
const GlobalNotification = () => {
  ...
  useEffect(() => {
    const dismissedData = localStorage.getItem(
      "eks-workshop-notification-dismissed",
    );
  ...
  return (
    <div
      className={`${styles.notification} ${isAnimating ? styles.notificationVisible : ""}`}
    >
